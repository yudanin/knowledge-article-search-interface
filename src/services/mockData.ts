 ...
 * This file simulates the data that would come from a real API
 */
...
export const mockCategories: Category[] = [
  ...
  { id: 'technical-support', name: 'Technical Support', count: 3 },
  { id: 'customer-service', name: 'Customer Service', count: 2 },
  { id: 'account-management', name: 'Account Management', count: 2 },
  { id: 'shipping', name: 'Shipping', count: 1 },
  { id: 'compliance', name: 'Compliance', count: 1 },
];

// Suggested search terms (simulating AI-powered suggestions)
